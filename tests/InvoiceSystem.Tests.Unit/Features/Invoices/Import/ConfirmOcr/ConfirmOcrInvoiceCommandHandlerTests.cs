...
using InvoiceSystem.Web.Features.Invoices.Import.ConfirmOcr;
using Microsoft.Extensions.Caching.Memory;
using Xunit;

namespace InvoiceSystem.Tests.Unit.Features.Invoices.Import.ConfirmOcr
{
    public class ConfirmOcrInvoiceCommandHandlerTests : IDisposable
    {
        ...
        public async Task Handle_Should_Return_ContractorExists_True_And_CreateInvoiceCommandJson_When_Contractor_Exists()
        {
            ...
            var parsedCommand = JsonSerializer.Deserialize<Web.Features.Invoices.CreateInvoice.CreateInvoiceCommand.CreateInvoiceCommand>(result.CreateInvoiceCommandJson!);
