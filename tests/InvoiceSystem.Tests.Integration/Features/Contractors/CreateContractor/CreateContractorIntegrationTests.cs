...
using InvoiceSystem.Web.Features.Contractors.CreateContractor.CreateContractorCommand;
...
namespace InvoiceSystem.Tests.Integration.Features.Contractors.CreateContractor
{
