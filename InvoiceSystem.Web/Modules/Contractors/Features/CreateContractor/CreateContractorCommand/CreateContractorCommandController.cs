...
using InvoiceSystem.Web.Modules.Contractors.Features.CreateContractor.GetCreateContractorQuery;
    ...
    public async Task<IActionResult> Index([FromForm] CreateContractorCommand command, CancellationToken cancellationToken)
    {
        try
        {
            ...
            if (!result.Success)
            {
                ...
                return View("~/Modules/Contractors/Features/CreateContractor/GetCreateContractorQuery/Index.cshtml", errorVm);
            }
        ...
        return View("~/Modules/Contractors/Features/CreateContractor/GetCreateContractorQuery/Index.cshtml", viewModel);
    }
}
